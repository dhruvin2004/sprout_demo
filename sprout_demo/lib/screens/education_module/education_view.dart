...
class EducationScreen extends StatelessWidget {
              ...
              child: ListView(
                ...
                children: [
                  ...
                  BaseText(text: "Please feel free to leave out your early education years! We don’t need to know where you went to kindergarten"
                    ,color: ColorRes.primaryColorLight02,fontSize: 18,),
  ...
  getSaveButton(EducationController _) {
    return Container(
      ...
      child: BaseRaisedButton(
        ...
        onPressed: () {
          _.getEducationResponse();
          print("========== print ==============");
          print("${_.controllerList}");
  ...
  getAddQualificationFunc(EducationController _ , int index){
    return Column(
      ...
      children: [
        SizedBox(height: Utils.getSize(20),),
        BaseText(text: "Instituition",color: ColorRes.primaryColorLight02,fontSize: 18,),
        ...
        SizedBox(height: Utils.getSize(10),),
        BaseText(text: "Qualification",color: ColorRes.primaryColorLight02,fontSize: 18,),
        SizedBox(height: Utils.getSize(6),),
        BaseTextField(
        ...
        SizedBox(height: Utils.getSize(10),),
        BaseText(text: "Year Of Completion",color: ColorRes.primaryColorLight02,fontSize: 18,),
        SizedBox(height: Utils.getSize(6),),
        BaseTextField(
